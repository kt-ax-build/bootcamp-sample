...
```
    ...
    └─────────────┘
    ┌─────────────┐
    │  Unit Test  │ ← JUnit 5 (백엔드 Service 계층)
    └─────────────┘
```
...
2. **E2E 테스트**: Cypress를 활용한 사용자 시나리오
3. **API 연동 테스트**: MSW를 활용한 API 모킹
